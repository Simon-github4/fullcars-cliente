...
public class CategoryForm extends JPanel implements Refreshable{
private static final long serialVersionUID = 1L;
	...
	private void save() { 
		Category m = new Category(null, nameTextField.getText());
	...
	private void delete() { 
		try {
			...
			if (JOptionPane.showConfirmDialog(null, "Desea eliminar la categoria: " + id.toString(), "",
	...
	private void createInputPanel() { 
		...
		titlePanel.add(LightTheme.createTitle("CATEGORIAS"));
		inputPanel.add(titlePanel);
	
		idTextField.setToolTipText("Identificador de la categoria (no se modifica)");
